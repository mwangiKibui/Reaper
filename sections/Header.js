        ...
        <header className='border-b border-gray-100 dark:border-gray-700'>
            <div className='xl:container xl:mx-auto flex flex-col'>
                <div className='container mx-auto flex flex-wrap p-0 flex-col md:flex-row items-center'>
                    <span className="flex title-font font-medium items-center mb-4 md:mb-0 ml-3 text-2xl justify-start sm:pt-2"><Link href='/'>Raspel</Link></span>
                    <div className='md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700'>
                        <nav >
                            ...
                            <Link href='/it' className={`inline-block p-4 ${router.pathname == "/it" ? "text-blue-600 text-xl border-b-2 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500" : "border-b-2 text-xl border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"}`}>IT Stuff</Link>
                ...
                <div className="absolute top-0 right-0 pt-5 h-10 w-16 sm:pt-2">
                    {renderThemeChanger()}
                </div>
            </div>
