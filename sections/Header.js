            ...
            <div className='container mx-auto flex flex-wrap p-0 flex-col md:flex-row items-center'>
                ...
                <div className='md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700'>
                    <nav >
                        ...
                        <Link href='/frontend' className={`inline-block p-4 ${router.pathname == "/frontend" ? "text-blue-600 border-b-2 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500" : "border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"}`}>FrontEnd</Link>
                        <Link href='/backend' className={`inline-block p-4 ${router.pathname == "/backend" ? "text-blue-600 border-b-2 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500" : "border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"}`}>BackEnd</Link>
